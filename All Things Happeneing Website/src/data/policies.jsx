/* ─────────────────────────────────────────────────────────────────
   ...
   Rendered both on the /policies page and inside the terms pop-up on
   the booking form. Kept here so the text a customer agrees to at
   checkout is literally the same text published on the site; two
   copies would drift, and an agreement that no longer matches the
   published policy is worth nothing in a dispute.

   `id` doubles as the anchor on /policies, so the pop-up can deep-link
   each section (e.g. /policies#cancellation).
   ───────────────────────────────────────────────────────────────── */
